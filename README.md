...
3. open a cmd in the folder and execute this command `npm i jimp robotjs system-sleep` (**Note**: if there are some errors while installing `robotjs` try start a cmd as administrator and use `npm install --global windows-build-tools`).
